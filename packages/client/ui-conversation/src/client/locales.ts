...
export const zh = {
  ...
  'qq.big.share': '分享',
  'qq.big.music': '音乐',
  'qq.big.groupmail': '群邮件',
  'qq.big.window': '窗口',
  'qq.big.blacklist': '黑名单',
  'qq.big.group': '群空间',
  'qq.small.font': 'A 字体',
  'qq.small.face': '表情',
  'qq.small.other': '其他',
  ...
  'qq.small.catch': '截图',
  'qq.small.scene': '场景',
  'qq.small.superbag': '超级表情',
  'qq.small.ptt': '语音对讲',
  'qq.bottom.history': '聊天记录(H)',
  'qq.bottom.mode': '消息模式(T)',
  'qq.bottom.down': '滚动到最新消息',
  'qq.bottom.menu': '打开命令面板',
  'qq.bottom.face': '插入表情',
  'qq.bottom.image': '插入图片引用模板',
  'qq.bottom.copy': '复制最近回复',
  'qq.bottom.theme': '主题循环',
  'qq.placeholder.hero': '想聊点什么？输入消息，Enter 发送',
  'qq.placeholder.default': '请输入消息，Enter 发送',
  'qq.placeholder.group': '发送到群（{n} 人）',
  'qq.date.today': '今天',
  'qq.date.yesterday': '昨天',
  'qq.announce': '群公告：',
  'qq.announceText': '本群共 {n} 名成员，{online} 名在线。欢迎在群里 @成员 协作任务。',
  'qq.memberCount': '群成员 {n} 人 · 在线 {online}',
  'qq.online': '在线',
  'qq.offline': '离线',
  'qq.winSkin.switched': '已切换聊天窗口配色：{name}',
  'qq.sidebarToggled': '已折叠/展开主面板',
  'qq.sessionCleared': '已清除当前会话',
  'qq.settingsUnavailable': '未找到设置入口，请从侧边栏打开设置',
  'qq.soundOn': '已开启新消息提示音',
  'qq.soundOff': '已关闭新消息提示音',
  'qq.viewSwitched': '已切换到视图：{view}',
  'qq.viewUnavailable': '视图 {view} 不可用',
  'qq.historyUnavailable': '暂无更多历史消息',
  'qq.scrollUnavailable': '消息列表尚未就绪',
  'qq.font.small': '消息字号：小',
  'qq.font.medium': '消息字号：中',
  'qq.font.large': '消息字号：大',
  'qq.noToolCall': '当前会话还没有工具调用',
  'qq.toolCallLocated': '已定位到最近一次工具调用',
  'qq.detailsOpened': '已打开详情面板',
  'qq.detailsClosed': '已收起详情面板',
  'qq.catalogOpened': '已打开子智能体目录',
  'qq.modelUnavailable': '模型选择暂不可用',
  'qq.commandsUnavailable': '命令面板暂不可用',
  'qq.shareText': '【{title}】会话分享\n会话 ID：{id}',
  'qq.shareCopied': '已复制会话分享文本',
  'qq.copyFailed': '复制失败，请重试',
  'qq.noReply': '还没有可复制的回复',
  'qq.replyCopied': '已复制最近回复',
  'qq.ttsUnavailable': '当前浏览器不支持语音朗读',
  'qq.ttsStopped': '已停止朗读',
  'qq.ttsStarted': '开始朗读最近回复',
  'qq.themeUnavailable': '主题切换暂不可用',
  'qq.themeSwitched': '已切换主题：{theme}',
  'qq.archived': '已归档当前会话',
  'qq.archiveFailed': '归档失败，请重试',
  'qq.inviteTemplate': '请启动一个子智能体加入协作：',
  'qq.inviteHint': '已预填子智能体启动指令',
  'qq.imageTemplate': '![图片](粘贴图片路径或描述)',
...
export const en = {
  ...
  'clock.md': '{m}/{d}',
  'clock.ymd': '{y}-{m}-{d}',
  // ── QQ2006 skin: chat window chrome copy ────────────────────────────────
  'qq.title.color': 'Change color',
  'qq.title.menu': 'Menu',
  'qq.title.hide': 'Hide',
  'qq.title.close': 'Close',
  'qq.big.sms': 'SMS',
  'qq.big.video': 'Video',
  'qq.big.voice': 'Voice',
  'qq.big.file': 'Send file',
  'qq.big.3d': '3D show',
  'qq.big.invite': 'Invite',
  'qq.big.share': 'Share',
  'qq.big.music': 'Music',
  'qq.big.groupmail': 'Group mail',
  'qq.big.window': 'Window',
  'qq.big.blacklist': 'Blacklist',
  'qq.big.group': 'Group space',
  'qq.small.font': 'A Font size',
  'qq.small.face': 'Emoji',
  'qq.small.other': 'More',
  'qq.small.picture': 'Picture',
  'qq.small.catch': 'Screenshot',
  'qq.small.scene': 'Scene',
  'qq.small.superbag': 'Super emoji',
  'qq.small.ptt': 'Push to talk',
  'qq.bottom.history': 'Chat history (H)',
  'qq.bottom.mode': 'Message mode (T)',
  'qq.bottom.down': 'Scroll to newest',
  'qq.bottom.menu': 'Open command menu',
  'qq.bottom.face': 'Insert emoji',
  'qq.bottom.image': 'Insert image template',
  'qq.bottom.copy': 'Copy last reply',
  'qq.bottom.theme': 'Theme cycle',
  'qq.placeholder.hero': 'What would you like to chat about? Type a message, Enter to send',
  'qq.placeholder.default': 'Type a message, Enter to send',
  'qq.placeholder.group': 'Send to group ({n} members)',
  'qq.date.today': 'Today',
  'qq.date.yesterday': 'Yesterday',
  'qq.announce': 'Group announcement: ',
  'qq.announceText': 'This group has {n} members, {online} online. Use @member to collaborate.',
  'qq.memberCount': '{n} members · {online} online',
  'qq.online': 'Online',
  'qq.offline': 'Offline',
  'qq.winSkin.switched': 'Chat window color: {name}',
  'qq.sidebarToggled': 'Main panel toggled',
  'qq.sessionCleared': 'Current session cleared',
  'qq.settingsUnavailable': 'No settings entry found; open Settings from the sidebar',
  'qq.soundOn': 'New-message alert sound on',
  'qq.soundOff': 'New-message alert sound off',
  'qq.viewSwitched': 'Switched to view: {view}',
  'qq.viewUnavailable': 'View {view} is unavailable',
  'qq.historyUnavailable': 'No older messages',
  'qq.scrollUnavailable': 'Message list is not ready yet',
  'qq.font.small': 'Message font: small',
  'qq.font.medium': 'Message font: medium',
  'qq.font.large': 'Message font: large',
  'qq.noToolCall': 'No tool calls in this session yet',
  'qq.toolCallLocated': 'Scrolled to the latest tool call',
  'qq.detailsOpened': 'Details panel opened',
  'qq.detailsClosed': 'Details panel closed',
  'qq.catalogOpened': 'Subagent catalog opened',
  'qq.modelUnavailable': 'Model selection is unavailable',
  'qq.commandsUnavailable': 'Command menu is unavailable',
  'qq.shareText': '[{title}] session share\nSession ID: {id}',
  'qq.shareCopied': 'Session share text copied',
  'qq.copyFailed': 'Copy failed; try again',
  'qq.noReply': 'No reply to copy yet',
  'qq.replyCopied': 'Last reply copied',
  'qq.ttsUnavailable': 'This browser does not support speech',
  'qq.ttsStopped': 'Speech stopped',
  'qq.ttsStarted': 'Reading the last reply aloud',
  'qq.themeUnavailable': 'Theme switching is unavailable',
  'qq.themeSwitched': 'Theme switched: {theme}',
  'qq.archived': 'Session archived',
  'qq.archiveFailed': 'Archiving failed; try again',
  'qq.inviteTemplate': 'Please launch a subagent to join the collaboration: ',
  'qq.inviteHint': 'Subagent launch prompt prefilled',
  'qq.imageTemplate': '![image](paste an image path or description)',
